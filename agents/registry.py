...
class Persona:
    ...
    escalation: str | None = None # secondary LLM for hard/long/cross-check work
    fallback_provider: str | None = None  # LLM to use if primary fails (credit exhausted, etc)
    channel_env: str | None = None  # env var holding the Slack channel ID (None until activated)
    active: bool = False
    phase: str = "0"      # phase at which this persona is/was activated
