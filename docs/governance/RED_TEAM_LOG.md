...
- **✅ red_team_clear: 2026-06-11** (AR-037). 내부 사용 한정, 외부 발행은 별도 게이트.
...
- **✅ red_team_clear: 2026-06-11** (AR-037 후속). residual: 머지 헬퍼가 generic이라 향후 sparse config 도메인에서 ''/0 clobber 이론적 가능(현 콜러 무영향).
