...
- 상태: **의제 등록 완료 — 실행 대기**(CEO '실행' 지시 시 구동). 요청서: `docs/governance/RED_TEAM_REQUEST_TURTLE_DIAGNOSIS_2026-06-27.md`. AR-20260627-003.
- 연계: Pre-Mortem `docs/governance/PRE_MORTEM_2026-06-27_turtle_paper_to_live.md`(AR-001), 진단 `docs/trading/TURTLE_SYSTEM_DIAGNOSIS_2026-06-27.md`(AR-002). 실계좌 진입은 P0·P1 해소 + turtle_gate_clear + pre_mortem_approve 전까지 보류.
